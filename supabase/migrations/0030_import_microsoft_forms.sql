...
-- Taller 1 calificado manualmente (MS Forms no auto-calificó, pero el
-- texto de respuesta está y se compara con el correct_index del website).
-- IDEMPOTENTE.
-- =========================================
...
-- ----------------------------------------
-- Taller 1 (114 estudiantes, 7 preguntas)
-- ----------------------------------------
do $$
declare
  v_taller_id uuid;
...
begin
  ...
  if v_taller_id is null then
    raise notice 'Taller 1 no encontrado, omitiendo.';
    return;
  end if;
  ...
  from (values
      ...
      ('adiel.jordan@meduca.edu.pa', 'Adiel Jordan', 7, '2026-03-22T18:43:10Z')
      ('adrian.saucedo@meduca.edu.pa', 'Adrian Saucedo', 5, '2026-04-25T16:24:13Z')
      ('ahiezer.ortega@meduca.edu.pa', 'Ahiezer Ortega', 6, '2026-03-23T20:00:32Z')
      ('alessandra.sanchez1@meduca.edu.pa', 'Alessandra Sanchez', 5, '2026-03-23T23:02:21Z')
      ('alexander.perez27@meduca.edu.pa', 'Alexander Perez', 6, '2026-04-01T22:01:35Z')
      ('andrea.quintero5@meduca.edu.pa', 'Andrea Quintero', 6, '2026-03-25T21:37:43Z')
      ('angel.agrazal5@meduca.edu.pa', 'Angel Agrazal', 7, '2026-03-26T13:39:34Z')
      ('angel.decaicedo@meduca.edu.pa', 'Angel Decaicedo', 7, '2026-04-07T22:18:29Z')
      ('angel.peralta5@meduca.edu.pa', 'Angel Peralta', 5, '2026-03-27T11:11:20Z')
      ('angel.rios19@meduca.edu.pa', 'Angel Rios', 5, '2026-05-02T20:39:09Z')
      ('angel.santamaria19@meduca.edu.pa', 'Angel Santamaria', 6, '2026-03-25T19:24:37Z')
      ('angela.delcid@meduca.edu.pa', 'Angela Delcid', 7, '2026-04-20T22:25:07Z')
      ('anyelis.garcia@meduca.edu.pa', 'Anyelis Garcia', 7, '2026-04-14T23:47:22Z')
      ('anyhelien.munoz@meduca.edu.pa', 'Anyhelien Munoz', 7, '2026-04-23T16:39:22Z')
      ('arafath.diaz@meduca.edu.pa', 'Arafath Diaz', 6, '2026-05-09T11:32:31Z')
      ('astry.marin@meduca.edu.pa', 'Astry Marin', 7, '2026-03-29T22:02:54Z')
      ('avril.montes@meduca.edu.pa', 'Avril Montes', 6, '2026-03-19T21:01:58Z')
      ('bladimir.cabrera@meduca.edu.pa', 'Bladimir Cabrera', 7, '2026-04-12T17:24:47Z')
      ('brayan.pitti1@meduca.edu.pa', 'Brayan Pitti', 6, '2026-04-26T15:07:21Z')
      ('capacitacion.ep14@meduca.edu.pa', 'Capacitacion Entre Pares 14', 3, '2026-03-19T19:22:47Z')
      ('carlos.mojica2@meduca.edu.pa', 'Carlos Javier Mojica Macias', 6, '2026-04-11T12:36:50Z')
      ('carlos.perez117@meduca.edu.pa', 'Carlos Pérez', 7, '2026-04-19T16:28:55Z')
      ('carlos.rivera23@meduca.edu.pa', 'Carlos Rivera', 5, '2026-03-21T18:59:41Z')
      ('cesar.vargas5@meduca.edu.pa', 'Cesar Vargas', 6, '2026-03-28T10:43:38Z')
      ('daniel.aparicio3@meduca.edu.pa', 'Daniel Aparicio', 6, '2026-04-25T20:21:22Z')
      ('daniel.cardenaz@meduca.edu.pa', 'Daniel Cardenaz', 7, '2026-05-13T17:49:03Z')
      ('dareni.espinosa@meduca.edu.pa', 'Dareni Espinosa', 6, '2026-04-19T20:03:53Z')
      ('darlenis.machuca@meduca.edu.pa', 'Darlenis Machuca', 7, '2026-03-27T15:14:31Z')
      ('darys.ojeda@meduca.edu.pa', 'Darys Ojeda', 6, '2026-03-20T15:05:05Z')
      ('debora.fabrega@meduca.edu.pa', 'Debora Fabrega', 6, '2026-05-14T13:40:08Z')
      ('diana.urena1@meduca.edu.pa', 'Diana Urena', 6, '2026-04-10T18:55:58Z')
      ('diego.nunez@meduca.edu.pa', 'Diego Moises Nunez Ojo', 6, '2026-04-05T21:21:35Z')
      ('diego.perez18@meduca.edu.pa', 'Diego Perez', 5, '2026-04-19T16:41:09Z')
      ('duvan.sanjur@meduca.edu.pa', 'Duvan Sanjur', 6, '2026-05-05T01:20:38Z')
      ('dylan.bethancourt6@meduca.edu.pa', 'Dylan Bethancourt', 7, '2026-04-07T21:13:48Z')
      ('elianys.samudio2@meduca.edu.pa', 'Elianys Samudio', 6, '2026-03-28T12:21:07Z')
      ('elma.olivares@meduca.edu.pa', 'Elma Olivares', 7, '2026-04-18T12:17:11Z')
      ('emanuel.hernandez5@meduca.edu.pa', 'Emanuel Hernandez', 5, '2026-03-27T04:59:19Z')
      ('eric.rodriguez66@meduca.edu.pa', 'Eric Rodriguez', 7, '2026-04-03T14:43:07Z')
      ('erika.pimentel2@meduca.edu.pa', 'Erika Pimentel', 7, '2026-04-19T09:42:21Z')
      ('ethan.rodriguez6@meduca.edu.pa', 'Ethan Rodriguez', 6, '2026-04-08T14:56:41Z')
      ('ethan.samaniego1@meduca.edu.pa', 'Ethan Samaniego', 7, '2026-03-31T17:20:41Z')
      ('evelyn.gallardo@meduca.edu.pa', 'Evelyn Gallardo', 7, '2026-04-06T17:26:53Z')
      ('eytan.duenas@meduca.edu.pa', 'Eytan Duenas', 6, '2026-03-20T16:49:56Z')
      ('fabiola.santamaria@meduca.edu.pa', 'Fabiola Santamaria', 6, '2026-03-24T19:59:26Z')
      ('gabriela.rodriguez91@meduca.edu.pa', 'Gabriela Rodriguez', 6, '2026-04-01T14:32:23Z')
      ('gamaliel.sanchez1@meduca.edu.pa', 'Gamaliel Sanchez', 7, '2026-04-19T18:13:40Z')
      ('genesis.chamapuro@meduca.edu.pa', 'Genesis Chamapuro', 7, '2026-03-26T19:28:27Z')
      ('genesis.quiros1@meduca.edu.pa', 'Genesis Quiros', 4, '2026-03-24T17:58:31Z')
      ('gian.ariano@meduca.edu.pa', 'Gian Ariano', 6, '2026-03-19T19:52:13Z')
      ('gretel.winkler@meduca.edu.pa', 'Gretel Winkler', 5, '2026-04-07T23:56:41Z')
      ('hector.pinilla@meduca.edu.pa', 'Hector Pinilla', 4, '2026-04-23T21:26:54Z')
      ('heily.gonzalez2@meduca.edu.pa', 'Heily Gonzalez', 3, '2026-03-31T22:43:29Z')
      ('ingrid.sandoval@meduca.edu.pa', 'Ingrid Solange Sandoval Mitre', 7, '2026-04-11T23:46:42Z')
      ('israel.reyes3@meduca.edu.pa', 'Israel Reyes', 6, '2026-03-19T21:54:54Z')
      ('jamie.batista@meduca.edu.pa', 'Jamie Batista', 7, '2026-03-26T16:20:46Z')
      ('joelis.rodriguez1@meduca.edu.pa', 'Joelis Rodriguez', 5, '2026-05-06T16:33:12Z')
      ('johan.camano8@meduca.edu.pa', 'Johan Camaño', 7, '2026-05-08T14:08:26Z')
      ('jorge.gonzalez116@meduca.edu.pa', 'Jorge Gonzalez', 6, '2026-04-04T16:14:18Z')
      ('jorge.sanchez52@meduca.edu.pa', 'Jorge Sanchez', 7, '2026-04-24T17:46:41Z')
      ('joshua.lynch@meduca.edu.pa', 'Joshua Lynch', 6, '2026-03-22T19:52:24Z')
      ('juan.poveda4@meduca.edu.pa', 'Juan Poveda', 4, '2026-04-09T19:03:41Z')
      ('juan.soto10@meduca.edu.pa', 'Juan Soto', 7, '2026-03-24T20:45:06Z')
      ('karla.cardenas@meduca.edu.pa', 'Karla Cardenas', 6, '2026-04-13T22:32:26Z')
      ('katherine.bonilla2@meduca.edu.pa', 'Katherine Bonilla', 6, '2026-03-19T20:18:22Z')
      ('kaytleen.perez@meduca.edu.pa', 'Kaytleen Perez', 7, '2026-03-24T13:17:51Z')
      ('kenedith.guerrero@meduca.edu.pa', 'Kenedith Guerrero', 5, '2026-04-01T16:19:53Z')
      ('kevin.gomez17@meduca.edu.pa', 'Kevin Gomez', 7, '2026-04-09T09:50:00Z')
      ('kiara.solorzano@meduca.edu.pa', 'Kiara Solorzano', 4, '2026-04-12T11:52:57Z')
      ('leicin.degracia@meduca.edu.pa', 'Leicin Degracia', 7, '2026-04-01T19:33:34Z')
      ('lishmary.degracia@meduca.edu.pa', 'Lishmary Degracia', 7, '2026-03-27T23:29:39Z')
      ('liz.castillo8@meduca.edu.pa', 'Liz Castillo', 7, '2026-05-03T18:09:14Z')
      ('luis.cristi@meduca.edu.pa', 'Luis Cristi', 6, '2026-03-22T13:54:35Z')
      ('luis.gaitan3@meduca.edu.pa', 'Luis Eduardo Gaitán Canto', 5, '2026-05-08T11:31:38Z')
      ('luis.gonzalez186@meduca.edu.pa', 'Luis Gonzalez', 7, '2026-03-29T20:24:19Z')
      ('luis.govea3@meduca.edu.pa', 'Luis Govea', 7, '2026-03-20T21:58:46Z')
      ('makir.vasquez@meduca.edu.pa', 'Makir Vasquez', 7, '2026-03-21T14:24:20Z')
      ('mareva.virgisela@meduca.edu.pa', 'Mareva Virgisela', 5, '2026-04-01T16:28:00Z')
      ('maria.rodriguez24@meduca.edu.pa', 'Maria Rodríguez', 6, '2026-04-13T22:37:03Z')
      ('maryuri.trottman@meduca.edu.pa', 'Maryuri Trottman', 6, '2026-03-23T15:40:30Z')
      ('melanie.frias1@meduca.edu.pa', 'Melanie Frias', 7, '2026-04-05T10:25:14Z')
      ('miguel.cruz3@meduca.edu.pa', 'Miguel Cruz', 6, '2026-03-31T19:37:32Z')
      ('miguel.rudas@meduca.edu.pa', 'Miguel Rudas', 6, '2026-04-17T05:30:48Z')
      ('moises.nunez@meduca.edu.pa', 'Moises Nuñez', 6, '2026-05-04T18:33:36Z')
      ('moises.prescott1@meduca.edu.pa', 'Moises Prescott', 7, '2026-04-07T14:56:00Z')
      ('nathaly.ruiz3@meduca.edu.pa', 'Nathaly Ruiz', 7, '2026-05-03T19:49:47Z')
      ('nefi.henry@meduca.edu.pa', 'Nefi Henry', 7, '2026-03-25T10:51:15Z')
      ('nelson.solis1@meduca.edu.pa', 'Nelson Josue Solis Gonzalez', 7, '2026-03-24T23:49:55Z')
      ('nixrah.alfonso@meduca.edu.pa', 'Nixrah Alfonso', 5, '2026-04-02T09:00:46Z')
      ('norielys.batista@meduca.edu.pa', 'Norielys Isabel Batista Martinez', 6, '2026-04-12T11:32:36Z')
      ('obareth.solano@meduca.edu.pa', 'Obareth Solano', 7, '2026-03-21T12:11:16Z')
      ('omar.caballero4@meduca.edu.pa', 'Omar Caballero', 6, '2026-03-27T20:19:19Z')
      ('oscar.aizprua@meduca.edu.pa', 'Oscar Aizprua', 7, '2026-03-26T15:26:28Z')
      ('oscar.gonzalez5@meduca.edu.pa', 'Oscar Antonio Gonzalez Barria', 6, '2026-04-28T17:58:40Z')
      ('rashel.navas@meduca.edu.pa', 'Rashel Navas', 5, '2026-05-05T20:38:50Z')
      ('rashell.armand@meduca.edu.pa', 'Rashell Armand', 4, '2026-04-21T20:35:38Z')
      ('raul.sanchez16@meduca.edu.pa', 'Raul Sanchez', 7, '2026-04-13T20:27:14Z')
      ('rocco.sanchez@meduca.edu.pa', 'Rocco Sanchez', 7, '2026-04-18T17:03:19Z')
      ('ronier.cabrera@meduca.edu.pa', 'Ronier Cabrera', 7, '2026-03-27T19:39:29Z')
      ('sahara.lana@meduca.edu.pa', 'Sahara Lana', 5, '2026-04-26T10:12:14Z')
      ('sara.abrego5@meduca.edu.pa', 'Sara Abrego', 3, '2026-03-23T08:40:45Z')
      ('sebastian.aparicio1@meduca.edu.pa', 'Sebastian Aparicio', 6, '2026-04-07T18:52:40Z')
      ('sergio.bosquez1@meduca.edu.pa', 'Sergio Bosquez', 6, '2026-04-19T22:37:56Z')
      ('sherlyn.quintana@meduca.edu.pa', 'Sherlyn Quintana', 4, '2026-03-26T14:25:10Z')
      ('sofia.carrera@meduca.edu.pa', 'Sofia Carrera', 7, '2026-04-23T15:16:33Z')
      ('victor.carrera3@meduca.edu.pa', 'Victor Carrera', 5, '2026-03-22T08:18:21Z')
      ('walter.mendoza2@meduca.edu.pa', 'Walter Mendoza', 4, '2026-04-16T18:36:43Z')
      ('william.bustamante@meduca.edu.pa', 'William Bustamante', 7, '2026-03-22T19:17:58Z')
      ('yeniskel.herrera@meduca.edu.pa', 'Yeniskel Herrera', 7, '2026-03-29T14:35:21Z')
      ('yorlenis.valdez@meduca.edu.pa', 'Yorlenis Valdez', 6, '2026-04-01T15:48:50Z')
      ('yulieth.quiros1@meduca.edu.pa', 'Yulieth Quiros', 7, '2026-03-30T22:36:35Z')
      ('yumeylis.marin@meduca.edu.pa', 'Yumeylis Marin', 5, '2026-03-24T19:25:18Z')
  ) as t(email, name, score, ctime)
  on conflict (taller_id, student_email) do update
    set score = greatest(quiz_responses.score, excluded.score),
        student_name = case
  ...
  raise notice 'Importación Taller 1 (MS Forms) completada.';
end $$;
